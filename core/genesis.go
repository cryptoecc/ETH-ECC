...
func CommitGenesisState(db ethdb.Database, hash common.Hash) error {
	...
	if len(blob) != 0 {
		...
		case params.WLseoulGenesisHash:
			genesis = DefaultWLseoulGenesisBlock()
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.WLseoulGenesisHash:
		return params.WLseoulChainConfig
...
func DefaultWLseoulGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.WLseoulChainConfig,
		Nonce:      0,
